...
const Header = () => {
  ...
  return (
    <div
      className={`w-full sticky top-0 h-16 z-50 transition-all duration-300 ${
    ...
    >
      <header className="h-full flex justify-between items-center px-6 mx-auto container">
        ...
        <div className="flex gap-8 items-center">
          ...
          {/***************** Mobile navigation *****************/}
          <div
            className={`flex items-center justify-center fixed top-16 left-0 right-0 bg-background shadow-lg h-[calc(100vh-4rem)] text-6xl px-4 ${
              isMobileNavOpen
